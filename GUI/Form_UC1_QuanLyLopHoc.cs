...
namespace GUI
{
    public partial class Form_UC1_QuanLyLopHoc : Form
    {
        ...
        {
            e.Graphics.DrawString("DANH SÁCH LỚP", new Font("Times New Roman", 24, FontStyle.Bold), Brushes.Black, new PointF(110, 80));

            e.Graphics.DrawString("Mã Lớp Học:", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new PointF(190, 140));
            e.Graphics.DrawString(txt_MaLop.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 140));

            e.Graphics.DrawString("Tên Lớp Học:", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new PointF(190, 140));
            e.Graphics.DrawString(txt_TenLop.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 140));

            e.Graphics.DrawString("Khối :", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new PointF(190, 140));
            e.Graphics.DrawString(cbo_khoi.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 140));
            ...
            e.Graphics.DrawString(txt_SiSo.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 200));

            e.Graphics.DrawString("Giáo Viên Chủ Nhiệm:", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new PointF(190, 230));
            e.Graphics.DrawString(cbb_gvcn.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 230));
