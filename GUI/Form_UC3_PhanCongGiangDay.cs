...
namespace GUI
{
    public partial class Form_UC3_PhanCongGiangDay : Form
    {
        ...
        {
            //dtg.DataSource = phanconggiangdayh.ShowPCGD();//chuyen di noi khac
        ...
        {
            e.Graphics.DrawString("DANH SÁCH PHÂN CÔNG GIẢNG DẠY", new Font("Times New Roman", 24, FontStyle.Bold), Brushes.Black, new PointF(150, 80));
        ...
        //private void btn_gv1l_Click(object sender, EventArgs e)
        //{
        //    Form_UC4_DanhSachGiaoVien1Lop frm = new Form_UC4_DanhSachGiaoVien1Lop() { Dock = DockStyle.Fill /*vị trí*/, TopLevel = false, TopMost = true /*nằm trên*/};
        //    this.Controls.Clear();  // xóa form trên panel
        //    this.Controls.Add(frm); //thêm vào fORM
