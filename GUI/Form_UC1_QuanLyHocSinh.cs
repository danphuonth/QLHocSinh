...
namespace GUI
{
    public partial class Form_UC1_QuanLyHocSinh : Form
    {
        ...
        private void dgv_LopHoc_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgv_HocSinh.Rows[dong].Cells[6] != null)
            {
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Có lỗiiiiiiiiiii!");
                }
            }
        }
        ...
        {
            e.Graphics.DrawString("DANH SÁCH HỌC SINH", new Font("Times New Roman", 24, FontStyle.Bold), Brushes.Black, new PointF(110, 80));

            e.Graphics.DrawString("Mã Học Sinh:", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new PointF(190, 140));
            e.Graphics.DrawString(txt_MaHocSinh.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 140));

            e.Graphics.DrawString("Họ Tên:", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new PointF(190, 140));
            e.Graphics.DrawString(txt_TenHocSinh.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 140));

            e.Graphics.DrawString("Ngày Sinh :", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new PointF(190, 140));
            e.Graphics.DrawString(txt_NgaySinh.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 140));

            e.Graphics.DrawString("Địa Chỉ:", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new PointF(190, 200));
            e.Graphics.DrawString(txt_DiaChi.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 200));

            e.Graphics.DrawString("Email:", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new PointF(190, 230));
            e.Graphics.DrawString(txt_Email.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 230));

            e.Graphics.DrawString("Lớp:", new Font("Times New Roman", 18, FontStyle.Bold), Brushes.Black, new PointF(190, 230));
            e.Graphics.DrawString(cbo_TenLop.Text, new Font("Times New Roman", 18, FontStyle.Italic), Brushes.Black, new PointF(450, 230));
